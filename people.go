...
func newPeople(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *People {
	return &People{
		rootSDK:          rootSDK,
...
func (s *People) Read(ctx context.Context, request operations.ReadPersonRequest, opts ...operations.Option) (*operations.ReadPersonResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/rest/people/{person_id}", request, globals)
	if err != nil {
	...
	res := &operations.ReadPersonResponse{
...
func (s *People) Update(ctx context.Context, request operations.UpdatePersonRequest, opts ...operations.Option) (*operations.UpdatePersonResponse, error) {
	...
	res := &operations.UpdatePersonResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
