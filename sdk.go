...
// Generated from OpenAPI doc version 3.0.0-beta107 and generator version 2.845.21
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.7.9",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.7.9 2.845.21 3.0.0-beta107 github.com/dailypay/dailypay-go-sdk",
