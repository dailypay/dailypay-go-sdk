...
// Generated from OpenAPI doc version 3.0.0-beta99 and generator version 2.778.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.6.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.6.2 2.778.0 3.0.0-beta99 github.com/dailypay/dailypay-go-sdk",
