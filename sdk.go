...
// Generated from OpenAPI doc version 3.0.0-beta01 and generator version 2.723.11
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.2.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.2.1 2.723.11 3.0.0-beta01 github.com/dailypay/dailypay-go-sdk",
