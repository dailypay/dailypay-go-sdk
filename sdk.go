...
// Generated from OpenAPI doc version 3.0.0-beta108 and generator version 2.866.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.7.10",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.7.10 2.866.0 3.0.0-beta108 github.com/dailypay/dailypay-go-sdk",
