...
// Generated from OpenAPI doc version 3.0.0-beta100 and generator version 2.787.2
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.7.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.7.0 2.787.2 3.0.0-beta100 github.com/dailypay/dailypay-go-sdk",
