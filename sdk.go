...
// Generated from OpenAPI doc version 3.0.0-beta01 and generator version 2.701.8
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.1.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.1.0 2.701.8 3.0.0-beta01 github.com/dailypay/dailypay-go-sdk",
