...
// Generated from OpenAPI doc version 3.0.0-beta102 and generator version 2.797.1
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.7.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.7.3 2.797.1 3.0.0-beta102 github.com/dailypay/dailypay-go-sdk",
