...
// Generated from OpenAPI doc version 3.0.0-beta.114 and generator version 2.884.7
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.7.16",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.7.16 2.884.7 3.0.0-beta.114 github.com/dailypay/dailypay-go-sdk",
