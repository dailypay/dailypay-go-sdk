...
// Generated from OpenAPI doc version 3.0.0-beta.115 and generator version 2.907.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.7.19",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.7.19 2.907.0 3.0.0-beta.115 github.com/dailypay/dailypay-go-sdk",
