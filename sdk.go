...
// Generated from OpenAPI doc version 3.0.0-beta.120 and generator version 2.927.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.7.23",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.7.23 2.927.0 3.0.0-beta.120 github.com/dailypay/dailypay-go-sdk",
