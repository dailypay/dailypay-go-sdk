...
// Generated from OpenAPI doc version 3.0.0-beta87 and generator version 2.755.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.5.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.5.2 2.755.0 3.0.0-beta87 github.com/dailypay/dailypay-go-sdk",
