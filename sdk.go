...
// Generated from OpenAPI doc version 3.0.0-beta01 and generator version 2.698.4
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.0.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.0.2 2.698.4 3.0.0-beta01 github.com/dailypay/dailypay-go-sdk",
