...
// Organizations - The _organizations_ endpoint provides details about a business entity,
...
func newOrganizations(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Organizations {
...
func (s *Organizations) Read(ctx context.Context, request operations.ReadOrganizationRequest, opts ...operations.Option) (*operations.ReadOrganizationResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/rest/organizations/{organization_id}", request, globals)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.OrganizationData
...
func (s *Organizations) List(ctx context.Context, request operations.ListOrganizationsRequest, opts ...operations.Option) (*operations.ListOrganizationsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/organizations")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.OrganizationsData
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.OrganizationsData = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
