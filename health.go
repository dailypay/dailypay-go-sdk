...
// Health - The _health_ endpoint provides a simple health check for the API.
//
...
func newHealth(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Health {
	return &Health{
		rootSDK:          rootSDK,
...
func (s *Health) GetHealth(ctx context.Context, opts ...operations.Option) (*operations.GetHealthResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/health")
	if err != nil {
