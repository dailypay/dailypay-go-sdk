...
func newTransfers(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Transfers {
	return &Transfers{
		rootSDK:          rootSDK,
...
func (s *Transfers) Read(ctx context.Context, request operations.ReadTransferRequest, opts ...operations.Option) (*operations.ReadTransferResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/rest/transfers/{transfer_id}", request, globals)
	if err != nil {
	...
	res := &operations.ReadTransferResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.TransferData
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.TransferData = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Transfers) List(ctx context.Context, request operations.ListTransfersRequest, opts ...operations.Option) (*operations.ListTransfersResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/transfers")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/vnd.api+json`):
			...
			var out components.TransfersData
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.TransfersData = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
