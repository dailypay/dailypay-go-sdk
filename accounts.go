...
func (s *Accounts) Read(ctx context.Context, request operations.ReadAccountRequest, opts ...operations.Option) (*operations.ReadAccountResponse, error) {
	...
	hookCtx := hooks.HookContext{
		...
		OAuth2Scopes:     []string{"client:lookup", "client:admin"},
...
func (s *Accounts) DeleteAccount(ctx context.Context, request operations.DeleteAccountRequest, opts ...operations.Option) (*operations.DeleteAccountResponse, error) {
	globals := operations.DeleteAccountGlobals{
		Version: s.sdkConfiguration.Globals.Version,
	}
