...
<!-- UsageSnippet language="go" operationID="createTransfer" method="post" path="/rest/transfers" example="Instant" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="createTransfer" method="post" path="/rest/transfers" example="NextDay" -->
```go
package main
        ...
        TransferCreateData: components.TransferCreateData{
            Data: components.TransferCreateResource{
                Attributes: components.TransferCreateAttributes{
                    ...
                    Amount: 15000,
                    Currency: "USD",
                    Schedule: components.TransferCreateAttributesScheduleNextBusinessDay,
                },
                Relationships: components.TransferCreateRelationships{
                    Origin: components.AccountRelationship{
                        Data: components.AccountIdentifier{
