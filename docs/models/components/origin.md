...
```go
switch origin.Type {
	case components.OriginTypeAccountRelationship:
		// origin.AccountRelationship is populated
	case components.OriginTypePaycheckRelationship:
		// origin.PaycheckRelationship is populated
}
```
